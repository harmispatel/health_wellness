            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control {{ ($errors->has('password')) ? 'is-invalid' : '' }}" name="password" id="newpassword" placeholder="Enter Your Password"  value="{{ old('password') }}">
                        <span class="input-group-text" onclick="ShowHidePasswords()" id="newPassIcon">
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control {{ ($errors->has('password')) ? 'is-invalid' : '' }}" name="confirm_password" id="password" placeholder="Enter Your Conform Password" value="{{ old('password') }}">
